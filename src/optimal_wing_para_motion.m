...
ObjectiveFunction=@flight_range_opt_obj_function;  % fitness and constraint functions——调用目标函数
...
fminsearchoptions=optimset('Display','iter-detailed','MaxFunEvals',2000,'MaxIter',2000,'TolX',1e-15,'TolFun',1e-15,'UseParallel','always'); % 初始搜索1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
