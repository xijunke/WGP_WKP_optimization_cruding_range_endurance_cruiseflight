...
Re=(2*PHI*R_wing1*f*C_aver1)/(nu)      % Re =210.9388;  % Re∈[100,1000];  % 2004-JEB-Dickinson: Re∈[100,1000]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% if (R_wing+xr0-3.5*C_aver)>0 || (-R_wing-xr0+2.5*C_aver)>0 || (100*nu-2*PHI*f*R_wing1*C_aver1)>0 || (2*PHI*f*R_wing1*C_aver1-1000*nu)>0
 if (R_wing+xr0-5*C_aver)>0 || (-R_wing-xr0+2.9*C_aver)>0 || (100*nu-2*PHI*f*(R_wing1+xr01)*C_aver1)>0 || (2*PHI*f*(R_wing1+xr01)*C_aver1-10000*nu)>0   
