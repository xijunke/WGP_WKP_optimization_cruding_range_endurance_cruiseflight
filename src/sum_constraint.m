...
% 建立约束之外的惩罚函数
% variable=[f,phi_m,K,eta_m,C_eta,Phi_eta,R_wingeff,C_avereff,xr,C_maxy];   % 10个变量
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 10个变量[f,phi_m,K,eta_m,C_eta,Phi_eta,R_wingeff,C_avereff,xr,C_maxy];  % for Wang ZJ wingbeat pattern
LB = [0,     0,            0.0001,  0,    0,  -pi/2,  3.004,  0.8854, 0.3289, 0];                   % Lower bound   
UB =[1000,75*pi/180,1,          pi/2,5,  0,      90,      45,       45,        0.356737];  % Upper bound 
...
% LB =[0,     0,    -pi, 0,    -pi,  -pi/4, 3.004, 0.8854, 0.3289, 0];              % Lower bound   % 10个变量     % for 谐波函数wingbeat  pattern
% UB=[300, pi/2, pi, pi/2, pi,   pi/4,  90,      45,        45,      0.35];          % Upper bound   % 10个变量     % for 谐波函数wingbeat  pattern
